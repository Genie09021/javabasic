...
public class ClassTest05 {
	public static void main(String[] args) {
		...
		a.show(); //(2,2)에서 크기가 8x7인 사각형
		
		System.out.println("b의 면적은 "+ b.squareArea()); // 면적은 36
		if(c.contains(a)) System.out.println("c는 a를 포함합니다."); // 출력
		if(c.contains(b)) System.out.println("c는 b를 포함합니다."); // 출력안댐
